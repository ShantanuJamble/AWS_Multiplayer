...
AFPSCharacter::AFPSCharacter()
{
	...
	NoiseEmmiterCompoenent = CreateDefaultSubobject<UPawnNoiseEmitterComponent>(TEXT("Noise Emmiter"));
}
...
void AFPSCharacter::Tick(float DeltatTime)
{
	Super::Tick(DeltatTime);
	if (!IsLocallyControlled())
	{
		FRotator NewRot = CameraComponent->RelativeRotation;
		//Pawn.cpp compresses the remoteview pitch to 1 byte. we need to uncompress it.
